...
"1":{
    ...
    "card_text": ["Roof finials, also known as chofa, are intricate decorative elements commonly found in Thai architecture.", "Thai roof tiers are a defining feature of traditional Thai architecture. Characterized by their multi-tiered design, these roofs typically consist of several layers, each adorned with intricate details and decorative elements.", "Inspired by Thai design principles, structures feature carved wooden details, sloping roofs, and ornate decorations."],
